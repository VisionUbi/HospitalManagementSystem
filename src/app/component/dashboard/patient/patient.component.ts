...
export class PatientComponent implements OnInit {
  ...
  allPatients : Patient []  =[];
  allDoctors : Doctor []  =[];
  displayedColumns: string[] = ['name', 'mobile',  'doctor','gender' , 'actions'];
  ...
  addPatient(){
    ...
    dialogRef.afterClosed().subscribe(data=>{
     ...
     this.openSnackBar("Registration of Patient is sucessfull ","OK")
      }
    }  )
  }
  ...
  editPatient(row : any){
    ...
    dialogRef.afterClosed().subscribe(data=>{
     ...
     this.openSnackBar("Patient is updated sucessfull ","OK")
      }
    }  )
